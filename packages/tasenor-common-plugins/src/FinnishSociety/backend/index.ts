...
import { Currency, Language, PluginCode, SchemeName, TsvFilePath, Version, ID } from '@tasenor/common'

class FinnishSociety extends SchemePlugin {

  constructor() {
    super('FinnishSociety' as SchemeName)

    this.code = 'FinnishSociety' as PluginCode
    this.id = 40 as ID
    this.title = 'Finnish Society'
    ...
    this.use = 'both'
    this.type = 'scheme'
    this.description = 'Small accounting scheme for Finnish societies i.e. rekisteröity yhdistys.'
