...
class VATEstonia extends DataPlugin {
  constructor() {
    super({ common: ['vat'], backend: [] })

    this.code = 'VATEstonia'as PluginCode
    this.title = 'VAT Data for Estonia'
    ...
    this.use = 'backend'
    this.type = 'data'
    this.description = 'This plugin provides data needed for VAT handling in Estonia.'
