...
class FinnishIncomeStatementReport extends ReportPlugin {

  constructor() {
    super('income-statement-detailed' as ReportID, 'income-statement' as ReportID)

    this.schemes = new Set(['FinnishLimitedCompanyComplete', 'FinnishLimitedCompanyLite'])

    this.code = 'FinnishIncomeStatementReport' as PluginCode
    this.id = 5 as ID
    this.title = 'Income Statement Report (Finnish)'
    ...
    this.use = 'backend'
    this.type = 'report'
    this.description = 'Income statement report translated in Finnish.'
...
export default FinnishIncomeStatementReport
