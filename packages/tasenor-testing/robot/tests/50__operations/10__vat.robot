...
Calculate VAT
    ...
    Page Should Contain                 Delayed VAT: 1,94€
    Page Should Contain                 Current VAT payable: 0,00€
...
Verify VAT from Report
    ...
    Page Should Contain Report Line     Siirtosaamiset                      1,94€
    Page Should Contain Report Line     Muut velat                          0,00€

    Select Report                       balance-sheet-detailed
    Page Should Contain Report Line     1845 Arvonlisäverosaamiset ennakkomaksuista (siirtosaamiset)          1,94€
    Page Should Contain Report Line     Siirtosaamiset yhteensä	            1,94€
