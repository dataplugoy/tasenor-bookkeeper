...
Wait for Info Message
    [Arguments]                         ${message}      ${timeout}=${DEFAULT_TIMEOUT}
    Wait Until Element is Visible       //*[contains(@class, "Message") and contains(@class, "info") and text() = '${message}']     ${timeout}

Wait for Message Gone
    Sleep                               5010ms
    Page Should Not Contain Element     //*[contains(@class, "Message") and contains(@class, "info")]
    Page Should Not Contain Element     //*[contains(@class, "Message") and contains(@class, "error")]
